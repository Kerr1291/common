...
public class VoxelGridSurface : MonoBehaviour
{
    ...
    public void Init( int resolution, VoxelGridWall wall )
    {
        ...
        Utils.GetOrAddComponentIfNull( ref meshFilter, gameObject );
        Utils.GetOrAddComponentIfNull( ref meshCollider, gameObject );
    ...
    void SmoothVertex(int vertex, float skip_height = 0f, bool skip_seams = true)
    {
        ...
        if( Utils.FastApproximately( vertexToSmooth.y, skip_height, .01f ) )
            return;
    ...
    public void FillFirstRowCache( MapLayer mesh_input )
    {
    ...
    public void TriangulateRows( MapLayer mesh_input )
    {
