...
public class GameArea : Generator
{
    ...
    public void GenerateArea(MapLayer boundry_layer)
    {
        ...
        Rect room_area = new Rect(RNG.Rand(new Vector2(5, 5), new Vector2(25, 25)), Vector2.one);
        ...
        Utils.Clamp( ref room_area, boundry_layer.ValidArea );
    ...
    public void GeneratePointData(MapLayer mesh_input)
    {
        ...
        for (int i = 0; i < mesh_input.Count; ++i)
        {
            ...
            Vector3 p = Utils.VectorXZ(m.pos, voxelPrefab.transform.localPosition.y);
            CreateVoxel(p);
        }
    }
    ...
    {
        //Utils.XYtoXZ( ref voxelPos, height );
