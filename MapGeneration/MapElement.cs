...
//TODO: implement this into the new voxel gen structure
...
{
    public static MapElement EmptyElement
    {
        get
        {
    ...
    public void CopyIDFrom( MapElement other )
    {
        id = other.id;
    }

    public bool HasIDInMask( List<Color> mask )
    {
        if( mask.Contains( id ) )
            return true;
        return false;
    ...
    public static bool CompareID( MapElement a, MapElement b )
    {
