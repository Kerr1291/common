...
public class BoidRules : MonoBehaviour
{
    ...
    void UpdateRules( CubeBoid boid, List<Collider> swarm )
    {
        ...
        for( int i = 0; i < swarm.Count; ++i )
        {
            ...
            Utils.VectorXZ(ref boundsPoint);
    ...
    void UpdateRules( CubeBoid boid, List<CubeBoid> swarm )
    {
        ...
        {
            //finalize rule 1
            //centerOfMassRule.vector = Utils.VectorXZ( -boid._transform.localPosition ).normalized;
            //finalize rule 3
        ...
        Utils.VectorXZ( ref positionSum );
        Utils.VectorXZ( ref velocitySum );
