...
public class VoxelGrid : MonoBehaviour
{
    ...
    public void Init( int resolution )
    {
        ...
        GridData.Resize( new Vector2( Resolution, Resolution ) );
    ...
    public virtual void GenerateGridData(bool invert = false, bool generate_collision_mesh = true)
    {
        ...
        MapLayer boundry_layer = BoundryLayer;
    ...
    public virtual void Refresh( MapLayer mesh_input, bool generate_collision_mesh = true )
    {
        Triangulate( mesh_input, generate_collision_mesh );
    }

    void Triangulate( MapLayer mesh_input, bool generate_collision_mesh = true )
    {
        surface.Clear();
