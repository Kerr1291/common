...
namespace Components
{
    ...
    public abstract class SymbolListControllerBase : MonoBehaviour
    {
    ...
    public abstract class GameDataListController<TGameData, TGameDataView> : SymbolListControllerBase
