...
namespace nv
{
    ...
    public class ListDemoScroller : ListViewScroller
    {
        ...
        public TimedRoutine ignoreTimer;
        public TimedRoutine extraPackageTimer;
        public TimedRoutine advanceTimer;

        public TimedRoutine spawnFun;
        ...
        public TimedRoutine cooldownTimer;
