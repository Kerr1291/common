...
public class PlatformerAvatar : Avatar
{
    ...
    void OnDisable()
    {
        if( ( Application.isEditor && GameCamera.GetGameCamera( GetPlayerID() ) != null && platformerController != null && platformerController.gameObject != null )
            || Application.isEditor == false )
            GameCamera.GetGameCamera( GetPlayerID() ).RemoveObjectFromTracking( platformerController.gameObject );
    }
