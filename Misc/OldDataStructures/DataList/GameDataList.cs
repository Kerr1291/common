...
namespace Components
{
    ...
    {
        public static JumpListOfGameData CreateSymbolJumpList()
        {
        ...
        public override void Add(GameData data)
        {
            if(!data.HasViewPrefab)
            {
                if(defaultPrefab != null)
                {
                    ...
                    Debug.LogWarning("Warning: Adding symbol without prefab information. Applying default symbol prefab to unknown symbol data with name: " + data.gameData);
                }
                else
                {
                    Debug.LogWarning("Warning: Adding symbol without prefab information. This may cause nullref errors. Symbol data name: " + data.gameData);
                }
            }
